...
public class Banque {
	...
	// Banque [comptesCourants=[CompteCourant [numero=1, solde=100.0, seuilDecouvertAutorise=0.0, proprietaire=Client [numero=1, nom=Dupont, anneeNaissance=0]],
	//CompteCourant [numero=4, solde=1010.0, seuilDecouvertAutorise=2000.0, proprietaire=Client [numero=2, nom=Durand, anneeNaissance=0]], CompteCourant 
	//[numero=3, solde=0.0, seuilDecouvertAutorise=0.0, proprietaire=Client [numero=1, nom=Dupont, anneeNaissance=0]], CompteCourant [numero=3, solde=0.0, 
	//seuilDecouvertAutorise=0.0, proprietaire=Client [numero=1, nom=Dupont, anneeNaissance=0]], null, null, null, null, null, null], nbComptesCourants=4, 
	//comptesEpargnes=[null, null, null, null, null, null, null, null, null, null], nbComptesEpargne=0]
	// 
