...
public class TestRectangle {
	...
	public static void main(String... args)
	{
		...
		// Appeler la mÈthde test.isRectangleValide
		// qui testera les mÈthodes avec diffÈrentes 
		// valeurs des attributs du rectangle R
		System.out.println(test.isRectangleValide());
		
		
		// Un CarrÈ EST UN Rectangle
		// donc un carrÈ doit aussi passer le test !
	...
	private boolean testAire() {
		...
		cas0 = (rectangleATester.aireRectangle() == 0 );
		
		rectangleATester.setLargeur(100);
		rectangleATester.setLongueur(1);
		casNormal = (rectangleATester.aireRectangle() == 100 );
		
		return cas0 && casNormal;
	}	
	
	// ici je supose qu'une valeur < 0 ne change pas la valeur 
	// mettre un 0 est valide aussi en fonction de ce qui a √©t√© defini. 
