...
public class Banque {
	...
	// dont la valeur dépend des bénéfices de toutes les banques 
	// au niveau national.
	...
	public static void main (String args []) {
		...
		// Créer les comptes
		CompteCourant cDupont = new CompteCourant (0, 0);
		CompteCourant cDurand = new CompteCourant (1000, 2000);
		CompteCourant cDupont2 = new CompteCourant (0, 0);
		CompteCourant cDurand2 = new CompteCourant (100, 50);
		...
		cDupont.crediter(100);
		System.out.println ("------------------------------");
		System.out.println ("Comptes du client Dupont apres un depot de 100 Euros:");
		bnp.afficherComptesClient ("Dupont");
		
		// Augmenter le taux de rémunération à 2%. 
		setTauxRemuneration(0.02);
		cDupont.crediter(100);
		System.out.println ("------------------------------");
		System.out.println ("Comptes du client Dupont apres un nouveau depot de 100 Euros:");
		bnp.afficherComptesClient ("Dupont");
		
		// Créer quelques comptes d'épargne
		CompteEpargne ceDupont = new CompteEpargne (0, 0.01);
		System.out.println ("------------------------------");
		System.out.println ("Compte epargne du client Dupont");
		ceDupont.afficher();
		ceDupont.crediter(400);
		ceDupont.afficher();
		
		// Afficher un compte à l'aide de toString()
		System.out.println("Afficher un compte à l'aide de toString");
		System.out.println(cDupont);
		// Affichage : 
		// CompteCourant [numero=1, solde=203.0, 
		// seuilDecouvertAutorise=0.0, proprietaire=banque.Client@2a0364ef]
	}
